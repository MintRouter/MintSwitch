  ...
  <div class="workspace">
    <aside class="sidebar" aria-label="MintSwitch settings">
      <div class="brand-block">
        ...
        <p class="brand-name">MintSwitch</p>
      </div>
...
<style>
  ...
  .sidebar{min-height:0;display:flex;flex-direction:column;padding:16px 14px 12px;background:var(--sidebar);border-right:1px solid var(--border)}.brand-block{display:flex;align-items:center;gap:10px;padding:0 4px 16px}.brand-mark{width:38px;height:38px;display:grid;place-items:center;color:var(--accent);border-radius:11px;background:var(--accent-soft);border:1px solid color-mix(in srgb,var(--accent) 18%,transparent)}.brand-name{margin:0;font-size:16px;line-height:1.15;font-weight:750;letter-spacing:-.025em}.sidebar-scroll{flex:1;min-height:0;overflow-y:auto;display:flex;flex-direction:column;gap:11px;padding:1px 2px 12px}.sidebar-scroll::-webkit-scrollbar,.content-scroll::-webkit-scrollbar{width:7px}.sidebar-scroll::-webkit-scrollbar-thumb,.content-scroll::-webkit-scrollbar-thumb{background:var(--scrollbar);border-radius:99px;border:2px solid transparent;background-clip:padding-box}
  .health-card{padding:16px;border:1px solid var(--border);border-radius:14px;background:var(--surface);box-shadow:var(--shadow-card)}.section-label{color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}.health-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:12px}.health-stat{padding:10px 2px;text-align:center;border-radius:10px;background:var(--surface-2)}.health-stat strong{display:block;font-size:18px;line-height:1}.health-stat span{display:block;margin-top:6px;color:var(--muted);font-size:11px}.health-stat.success strong{color:var(--ok)}.health-stat.warning strong{color:var(--warn)}
  aside.sidebar :global(.promo-row.promo-row){margin:0 2px 12px}
  .sidebar-footer{display:flex;align-items:center;justify-content:flex-end;gap:8px;padding:11px 2px 0;border-top:1px solid var(--border)}.icon-button{width:34px;min-height:34px;padding:0;display:inline-grid;place-items:center;flex:0 0 auto;color:var(--muted);background:var(--surface);border:1px solid var(--border);border-radius:9px;cursor:pointer;transition:.15s}.icon-button:hover:not(:disabled){color:var(--text);border-color:var(--border-strong);background:var(--surface-hover)}.icon-button:disabled{opacity:.45;cursor:default}
  .main-panel{min-width:0;min-height:0;display:flex;flex-direction:column}.main-header{flex:0 0 auto;min-height:94px;padding:16px 22px;display:flex;align-items:center;justify-content:space-between;gap:18px;border-bottom:1px solid var(--border)}.main-header h1{margin:0;font-size:22px;line-height:1.15;font-weight:760;letter-spacing:-.035em}.header-actions{display:flex;align-items:center;gap:7px}.header-actions .btn-primary,.header-actions .btn-ghost{min-height:34px}.bulk-apply{box-shadow:0 5px 16px color-mix(in srgb,var(--accent) 24%,transparent)}.spinning{animation:spin .8s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}

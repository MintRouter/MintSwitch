...
var errMissingKey = errors.New("opencode: a MintRouter API key is required to inject the MCP server")

// serverEntry builds the JSON object written under mcp.<name> for spec. OpenCode
// remote servers carry an explicit "enabled" flag.
